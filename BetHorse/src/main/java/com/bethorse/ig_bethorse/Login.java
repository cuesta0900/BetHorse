...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        typeUser.setBackground(new java.awt.Color(128, 128, 128));
        typeUser.setForeground(new java.awt.Color(255, 255, 255));
        typeUser.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione o tipo de usuário", "Dono", "Apostador" }));
        jPanel1.add(typeUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 240, 231, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 370, 90, 40));
        ...
        jPanel1.add(senhaLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 302, 229, 20));
        ...
        jPanel1.add(Senha, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 300, 231, -1));
        ...
        jPanel1.add(mostrarSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 330, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int tipo = typeUser.getSelectedIndex();
        if(email.equals("@@8556@@") && senha.equals("ADM-SILVA")){
            Admin adm = new Admin();
            adm.setVisible(true);
            dispose();
        }
        log.Logar(con, email, senha, tipo);
        if (log.getFlagl() == 1){
            dispose();
        }
